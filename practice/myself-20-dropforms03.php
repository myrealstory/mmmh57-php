            ...
            <div class="mb-3">
                ...
                <?php foreach ($hobbies as $k => $v) : ?>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="hobby2" id="hobb2-<?= $k ?>" value="<?= $k ?>" <?= $data['postData']['hobby2'] == $k ? 'checked' : '' ?>checked>
            ...
            <div class="mb-3">
                ...
                <?php foreach ($hobbies as $k => $v) : ?>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="hobby3-<?= $k ?>" value="<?= $k ?>" <?= in_array($k, $data['postData']['hobby3']) ? 'checked' : '' ?> name="hobby3[]">
